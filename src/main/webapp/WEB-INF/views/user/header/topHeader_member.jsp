	...
	%>	<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> 02-2188-6900</a></li>
					...
					<ul class="header-links pull-right">
						<li><a href="/myPage"><i class="fas fa-sign-in-alt"></i><%=userName%>님, 환영합니다.</a></li>
						<li><a href="/logout"><i class="fas fa-user-friends"></i>로그아웃</a></li>
					</ul>
				</div>
			</div> 
	<%		
